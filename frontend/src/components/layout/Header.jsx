...
import { Bars3Icon, XMarkIcon, ChevronDownIcon, UserCircleIcon, ArrowRightOnRectangleIcon, EyeIcon, EyeSlashIcon } from '@heroicons/react/24/outline';
                    ...
                    <Menu.Items className="origin-top-right absolute right-0 mt-2 w-48 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 focus:outline-none">
                      ...
                      <Menu.Item key={role.id}>
                        {({ active }) => (
                          <a
                            href={role.path}
                            onClick={(e) => handleNavigation(e, { ...role, app: role.id })}
