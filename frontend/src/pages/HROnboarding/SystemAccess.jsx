...
const SystemAccess = ({ moveToNextStep, moveToPreviousStep, onStepComplete }) => {
  ...
  const handleActivateEmployee = async () => {
    if (validateForm()) {
      ...
      try {
        // Simulate API call to activate employee
        ...
        alert('Employee activated successfully! Welcome email has been sent.');
  ...
  return (
    <div className="form-container">
      ...
      <form onSubmit={(e) => { e.preventDefault(); handleActivateEmployee(); }}>
        {/* Employee Summary */}
