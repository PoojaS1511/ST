...
const NotificationManagement = () => {
  ...
  const handleEdit = (notification) => {
    ...
    setFormData({
      ...
      is_scheduled: notification.status === 'scheduled',
    ...
    <Box sx={{ p: 3 }}>
      ...
      <Card>
        ...
        >
          ...
          <Tab label="Scheduled" value="scheduled" icon={<ScheduleIcon />} iconPosition="start" />
        </Tabs>
                ...
                >
                  <Box flexGrow={1}>
                    ...
                    <Box display="flex" alignItems="center">
                      ...
                      {notification.status === 'scheduled' && notification.scheduled_time && (
                        <Typography variant="caption" color="text.secondary" sx={{ ml: 2 }}>
                          Scheduled for: {format(new Date(notification.scheduled_time), 'PPpp')}
                        </Typography>
                      )}
                    </Box>
                  </Box>
