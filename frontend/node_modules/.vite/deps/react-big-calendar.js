...
} from "./chunk-ZOOKS4VB.js";
import {
  _typeof
} from "./chunk-EKTLDKRI.js";
import {
  require_react_dom
...
function uncontrolledPropTypes(controlledValues, displayName) {
  ...
  Object.keys(controlledValues).forEach(function(prop) {
    ...
    if (process.env.NODE_ENV !== "production") {
      ...
      !(typeof handler === "string" && handler.trim().length) ? process.env.NODE_ENV !== "production" ? (0, import_invariant.default)(false, "Uncontrollable - [%s]: the prop `%s` needs a valid handler key name in order to make it uncontrollable", displayName, prop) : (0, import_invariant.default)(false) : void 0;
...
// node_modules/react-overlays/esm/index.js
