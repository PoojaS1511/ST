...
import {
  createClient
} from "./chunk-GLDEYBXU.js";
import "./chunk-5I23QVHR.js";
import {
  require_dist as require_dist4
} from "./chunk-J3ZUWZFI.js";
import {
  __toESM,
  require_dist,
  require_dist2,
...
var cookie = __toESM(require_dist4());
...
var import_cookie = __toESM(require_dist4());
      ...
      storage: {
        ...
        getItem: async (key) => {
          ...
          const chunkedCookie = await combineChunks(key, async (chunkName) => {
            const cookie2 = (allCookies == null ? void 0 : allCookies.find(({ name }) => name === chunkName)) || null;
            if (!cookie2) {
              return null;
            }
...
https://supabase.com/dashboard/project/_/settings/api`);
  ...
  const client = createClient(supabaseUrl, supabaseKey, {
    ...
    auth: {
      ...
      persistSession: true,
      storage,
      ...(options == null ? void 0 : options.cookies) && "encode" in options.cookies && options.cookies.encode === "tokens-only" ? {
        userStorage: ((_c = options == null ? void 0 : options.auth) == null ? void 0 : _c.userStorage) ?? window.localStorage
      } : null
    }
  });
...
https://supabase.com/dashboard/project/_/settings/api`);
  ...
  const client = createClient(supabaseUrl, supabaseKey, {
    ...
    auth: {
      ...
      storage,
      ...(options == null ? void 0 : options.cookies) && "encode" in options.cookies && options.cookies.encode === "tokens-only" ? {
        userStorage: ((_c = options == null ? void 0 : options.auth) == null ? void 0 : _c.userStorage) ?? memoryLocalStorageAdapter()
      } : null
    }
  });
...
// node_modules/@supabase/auth-helpers-nextjs/dist/module/index.js
var _a;
if (typeof process !== "undefined" && ((_a = process.env) == null ? void 0 : _a.npm_package_name)) {
...
//# sourceMappingURL=@supabase_auth-helpers-nextjs.js.map
